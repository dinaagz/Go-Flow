...
const CM_DEFS={
  catalogue:[
    {k:'photos', lbl:'Photo',                           def:true},
    {k:'ref',    lbl:'Référence',                       def:true},
    {k:'nom',    lbl:'Désignation',                     def:true},
    {k:'cat',    lbl:'Catégorie',                       def:true, mob:false},
    {k:'four',   lbl:'Fournisseur',                     def:true},
    {k:'moq',    lbl:'MOQ',                             def:false,mob:false},
    {k:'specs',  lbl:'Spécificités',                    def:false,mob:false},
    {k:'desc',   lbl:'Description',                     def:false,mob:false},
    {k:'cbm',    lbl:'CBM',                             def:false,mob:false},
    {k:'poids',  lbl:'Poids',                           def:false,mob:false},
    {k:'achat',  lbl:'Achat EXW',                       def:false,mob:false},
    {k:'prach',  lbl:'Fret local',                      def:false,mob:false},
    {k:'revient',lbl:'Coût de Revient HT',              def:true, mob:false},
    {k:'fret',   lbl:'Frais logistiques (Transitaire)', def:true, mob:false},
    {k:'marge',  lbl:'Marge',                           def:true},
    {k:'vente',  lbl:'Prix de Vente HT',                def:true},
    {k:'ttc',    lbl:'Prix de Vente TTC',               def:true},
    {k:'delai',  lbl:'Délai livraison',                 def:false,mob:false},
    {k:'marche', lbl:'Prix marché',                     def:false,mob:false},
  ],
  simulation:[
    {k:'produit',  lbl:'Produit',                          def:true},
    {k:'ref',      lbl:'Référence',                        def:false,mob:false},
    {k:'four',     lbl:'Fournisseur',                      def:true, mob:false},
    {k:'moq',      lbl:'MOQ',                              def:false,mob:false},
    {k:'specs',    lbl:'Spécificités',                     def:false,mob:false},
    {k:'desc',     lbl:'Description',                      def:false,mob:false},
    {k:'qte',      lbl:'Quantité',                         def:true},
    {k:'transport',lbl:'Transport / CBM / Poids',          def:true, mob:false},
    {k:'achat',    lbl:'Coût d\'achat + frais (étape 1)',  def:true, mob:false},
    {k:'revient_u',lbl:'Coût de revient unitaire',         def:true},
    {k:'taux',     lbl:'Taux de change',                   def:true, mob:false},
    {k:'marge',    lbl:'Marge unitaire (%)',               def:true},
    {k:'marge_tot',lbl:'Marge totale',                     def:true, mob:false},
    {k:'vente_ht', lbl:'Prix de Vente HT',                 def:true},
    {k:'fret',     lbl:'Frais logistiques (Transitaire)',  def:true},
    {k:'vente_ttc',lbl:'Prix de Vente TTC unitaire',       def:true},
  ],
  devis:[
